...
import { signUp } from "@/lib/dao/signin_signup";
  ...
  return (
    <form action={dispatch} className="w-full">
      <div className="w-full rounded-lg bg-gray-50 pt-6 pb-4 px-6">
        ...
        <button className="mt-8 w-full rounded-lg bg-gray-800 text-white h-10 hover:bg-gray-400 focus-visible:outline-offset-2">
          Sign Up
        </button>
